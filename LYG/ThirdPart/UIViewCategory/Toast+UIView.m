...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        CGRect frame = [title boundingRectWithSize:maxSizeTitle
                                           options:NSStringDrawingUsesLineFragmentOrigin
                                        attributes:@{NSFontAttributeName:titleLabel.font}
                                           context:NULL];
        CGSize expectedSizeTitle = frame.size;
    ...
    if (message != nil) {
        ...
        CGRect frame = [message boundingRectWithSize:maxSizeMessage
                                           options:NSStringDrawingUsesLineFragmentOrigin
                                        attributes:@{NSFontAttributeName:messageLabel.font}
                                           context:NULL];
        CGSize expectedSizeMessage = frame.size;
